...
public class Test_Class {
	...
	@Test
	 public void testing_methods_class_Methods () {
		...
		System.out.println("\nThe method 'getPositivInt' for collecting only a possitive number:\n");
		...
		System.out.println("\nThe method 'getValidPassword' for collecting the password corresponding to the requirments, i.e. at least\n"
